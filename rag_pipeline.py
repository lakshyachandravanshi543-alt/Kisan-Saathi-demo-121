...
Helpful Answer:"""
    ...
    try:
        ...
        if "armyworm" in q_lower or "army worm" in q_lower:
            ...
            return "Based on the knowledge base, here is a brief guide to Indian soil types for crops:\n\n1. **Black Cotton Soil**: Excellent for cotton and sugarcane due to high moisture retention.\n2. **Alluvial Soil**: Highly fertile, found in river plains, ideal for wheat, rice, and maize.\n3. **Red Soil**: Good for pulses and oilseeds; requires added fertilizers.\n4. **Laterite Soil**: Good for tea, coffee, and cashew nuts.\n5. **Sandy/Desert Soil**: Suitable for drought-resistant crops like bajra and millets.\n\n*Always ensure proper soil testing before the sowing season.*"
